...
<section class="user-details">
   ...
   <div class="user">
      ...
      <p class="address"><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'Ingrese su dirección por favor';}else{echo $fetch_profile['address'];} ?></span></p>
